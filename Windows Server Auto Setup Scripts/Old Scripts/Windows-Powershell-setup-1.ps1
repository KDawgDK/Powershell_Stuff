...
New-NetIPAddress -IPAddress 192.168.20.6 -InterfaceIndex $adapter -DefaultGateway 192.168.20.1 -AddressFamily IPv4 -PrefixLength 24; #Setting the IP address of the server to the one specified at -IPAddress and Gateway specified at -DefaultGateway
